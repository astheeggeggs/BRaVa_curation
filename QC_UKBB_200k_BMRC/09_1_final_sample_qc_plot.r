...
# Inputs
SAMPLE_BEFORE_QC_FILE <-  '/well/lindgren/UKBIOBANK/dpalmer/wes' + TRANCHE + '/ukb_wes_qc/data/samples/09_final_qc_chr@.before.'
SAMPLE_AFTER_QC_FILE <-  '/well/lindgren/UKBIOBANK/dpalmer/wes' + TRANCHE + '/ukb_wes_qc/data/samples/09_final_qc_chr@.after.'

# Outputs
SAMPLE_BEFORE_AFTER_COMBINED_QC_FILE <- '/well/lindgren/UKBIOBANK/dpalmer/wes' + TRANCHE + '/ukb_wes_qc/data/samples/09_final_qc.before.after.combined.samples.tsv'
