...
# This is https://github.com/BRaVa-genetics/BRaVa_curation/blob/main/merged_annots_and_AC.r
rscript_remote="Duncan/counts/scripts/merged_annots_and_AC.r"
...
in_dir="/mnt/project/Duncan/long_annotations_no_spliceAI"
out_dir="/Duncan/annotation_counts_no_spliceAI"
dx mkdir -p ${out_dir}

# Excluding spliceAI information from the annotation
for anc in AFR AMR EAS EUR SAS; do
   for CHR in {{1..22},X}; do
      out_prefix="ukb_wes_450k.${anc}.chr${CHR}"
      AC_path=/mnt/project/Duncan/counts/plink.frqx.chr${CHR}.${anc}.gz
